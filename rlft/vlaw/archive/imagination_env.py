...
if TYPE_CHECKING:
    from rlft.vlaw.ctrl_world_adapter import CtrlWorldAdapter

# 复用 data_collector 中的状态提取工具
from rlft.vlaw.data_collector import extract_agent_state

# 复用 imagination.py 中的数据容器和工具函数
from rlft.vlaw.imagination import SyntheticTrajectory, _load_initial_frames
