...
DEFAULT_RL_VLA_ROOT = Path(__file__).resolve().parents[3]
DEFAULT_ROBOMETER_CHECKPOINT = DEFAULT_RL_VLA_ROOT / "checkpoints" / "robometer" / "Robometer-4B"
...
class EvalServerConfig:
    ...
    model_path: str = field(
        default=str(DEFAULT_ROBOMETER_CHECKPOINT),
