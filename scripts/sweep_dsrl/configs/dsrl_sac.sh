...
SEED_CONFIGS=(
    ...
    "$(_make_config "seed_steps_500"  num_seed_steps 500)"
    # baseline uses 1000
    "$(_make_config "seed_steps_5000" num_seed_steps 5000)"
)
...
# =============================================================================
# Group 14: Combined (promising combinations inspired by dsrl_official)
# =============================================================================
COMBINED_CONFIGS=(
    ...
    "combined_warmup_long:--num_seed_steps 5000 --init_temperature 0.5 --log_std_init -5.0"
)
