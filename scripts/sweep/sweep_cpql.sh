#!/bin/bash
# =============================================================================
# Sweep: CPQL (Offline RL 算法)
# 
# 扫描参数: alpha, reward_scale
# 继承: consistency_flow 的最优参数
# =============================================================================
...
SWEEP_SPECIFIC_CONFIGS=(
    # === alpha 扫描 (conservative penalty) ===
    "--alpha 0.001 --reward_scale 0.1"
    "--alpha 0.01 --reward_scale 0.1"
    "--alpha 0.1 --reward_scale 0.1"
    
    # === reward_scale 扫描 (alpha=0.01) ===
    "--alpha 0.01 --reward_scale 0.01"
    "--alpha 0.01 --reward_scale 1.0"
    
    # === 组合扫描 ===
    "--alpha 0.001 --reward_scale 0.01"
