#!/bin/bash
# VLAW Fresh Start Phase 1 — Ctrl-World WM 微调 (v2 干净数据)
#
# 参数选择依据:
...
#
# 数据: v2 干净数据 (1306 条轨迹, 3 HDF5, BUG-022 修复后收集)
# GPU:  0-3, DeepSpeed ZeRO-2, 4 GPU
# env:  conda ctrl_world
#
# 用法:
#   bash scripts/vlaw/run/train_wm_iter1_v2.sh 2>&1 | tee logs/vlaw/train_wm_iter1_v2.log
...
# Output
OUTPUT_DIR="${ROOT}/checkpoints/vlaw/world_model/iter1_v2"
...
echo "========================================"
echo "  Fresh Start Phase 1 — WM Fine-tuning (v2)"
echo "  GPUs:     ${CUDA_VISIBLE_DEVICES}"
echo "  Data:     ${DATASET_ROOT}/${DATASET_NAMES} (v2, 1306 traj)"
